...
class CosineSimilarityAlgorithm(BaseAlgorithm):
    """
    <p><h3>Косинусное сходство</h3>
    <p>является мерой сходства между двумя векторами(документами) с внутренним <br>пространством представления, который измеряет косинус угла между ними.</p>
    <p>Если сходство равно <b>&laquo;1&raquo;,</b> значит сравниеваемые системы <b>подобны</b>.<br>
    Если сходство равно <b>&laquo;0&raquo;,</b> значит сравниеваемые системы <b>не подобны</b>.</p>
    </p>
    """
