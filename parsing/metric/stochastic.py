...
class StochasticAlgorithm(BaseAlgorithm):
    ...
    <p>метод сравнивает системы описанные на естественном языке и позволяет перейти к интервальной шкале энтропии с использованием критерия стохастического подобия.</p>
